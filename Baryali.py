#!/usr/bin/python2
#coding=utf-8
#The Credit For This Code Goes To MR ToOra
...
\033[1;91mвЂўв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”ЂвЂў
\033[1;97mвЂў-----------------\033[1;37m mr ToOra\033[1;97m-----------------вЂў
 \033[1;97mвЂўв–…в–…в–…в–…в–…в–…в–…в–…в–…в–…в–…в–…в–…в–…в–…в–…в–…в–…в–…в–…в–…в–…в–…в–…в–…в–…
\033[1;41m\033[1;37m[вљЎрџ”Ґ\033[1;37mAuthor Name: MALAK ZARAK рџ”ҐвљЎ\033[1;37m]\033[1;0m
\033[1;41m\033[1;37m[вљЎрџ”Ґ\033[1;37mвЏ в†’+923123879770 рџ”ҐвљЎ\033[1;37m]\033[1;0m Techрџ”ҐвљЎ\033[1;37m]\033[1;0m
...
\033[1;96m l ToorYan GanG
\033[1;95m | Mr Zarak Khan
 \033[1;97m| Mr ToOra
 \033[1;94m l Mr Bilalo Khan
  \033[1;93m Mr Kamo Khan
 \033[1;92m Mr Shah Xaib Khan
\033[1;91m | Mr Dajal
\033[1;93m | Mr BarYali Khan
 \033[1;95m| Onwer Of ToOrYan
 \033[1;94m| Papa
\033[1;91m | BoSs
...
\033[1;92mвЂўв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”ЂвЂў
 \033[1;97mвЂўв–…в–…в–…в–…в–…в–…в–…в–…в–…в–…в–…в–…в–…в–…в–…в–…в–…в–…в–…в–…в–…в–…в–…в–…в–…в–…
 """
CorrectUsername = "ToOra"
CorrectPassword =  "MrZarak"
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            print "Logged in successfully as " + username #Dev: ToorYan GanG
	    time.sleep(2)
            loop = 'false'
        else:
...
def login1():
	...
	try:
		...
		os.system('clear')
                time.sleep(0.05)
		print logo                
		print "\033[1;97mвЂў-----------------\033[1;37m Mr ToOra \033[1;97m-----------------вЂў"
		...
		if 'save-device' in url:
			try:
				...
				unikers.close()
				print '\033[1;47m\033[1;91mToorYan GanG Login Successful\033[1;0m'
				os.system('xdg-open https://www.youtube.com/c/UCQdBT_TMMD3l6CrS6JxiUSQ')
...
def menu():
	...
	try:
		...
		keluar()
	os.system("clear") #Dev: ToorYan GanG
	print logo
	...
	time.sleep(0.05)
	print "\033[1;97mвЂў-----------------\033[1;37m Mr ToOr \033[1;97m-----------------вЂў"
	...
	time.sleep(0.05)
	print "\033[1;94m[3]\033[1;47m\033[1;31mRest/Update Mr ToOra                       \033[1;0m"
	time.sleep(0.05)
...
def pilih():
	...
	if unikers =="":
		...
		print "\033[1;95m...............\033[1;91mDataReset\033[1;95m.................."
                ...
                jalan('\033[1;95m=========90%')
                jalan('\033[1;94m==========100%')
                jalan('\033[1;93mCloning Data Reset and update by Mr ToOr')
...
def pilih_super():
	...
	if peak =="":
		...
		os.system('clear')
		print "\033[1;97mвЂў-----------------\033[1;37mMr ToOra  \033[1;97m-----------------вЂў"
		print logo
		jalan('\033[1;97m[+]\033[1;91mMr ToOraв–€в–€в–€в–€в–€в–€в–€в–€в–€в–€в–€в–€в–€в–€в–€в–€в–€в–’в–’в–’в–’в–’в–’в–’в–’..99%\033[1;97m:-:')
	...
	p.map(main, id)
#Dev:DARK-STORM-BOYS
        print "\033[1;97mвЂў-----------------\033[1;37mрџ”ҐMr ToOrрџ”Ґ\033[1;97m-----------------вЂў"
	...
	print "\033[1;97mВ«-----------------\033[1;37mрџ”ҐMr ToOrрџ”Ґ\033[1;97m-----------------В»"
	print """
 \033[1;97m
...
""
	print "\033[1;97mВ«-----------------\033[1;37mвњ…Mr ToOr вњ…\033[1;97m-----------------В»"
...
"""
	print "\033[1;97mВ«-----------------\033[1;37mвњ…ToorYan GanGвњ…\033[1;97m-----------------В»"
	raw_input("\n\033[1;97m[+]\033[1;97mBack")
	menu()
